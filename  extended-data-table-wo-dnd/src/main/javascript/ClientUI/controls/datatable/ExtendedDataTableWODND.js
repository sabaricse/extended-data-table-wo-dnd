if (!window.ExtendedDataTableWODND) window.ExtendedDataTableWODND = {};

ExtendedDataTableWODND.DataTable = Class.create({
	initialize : function(id, options) {
		...
		this.selectionManager = new ExtendedDataTableWODND.SelectionManager(options, this);
	...
	createControls: function() {
		...
		this.header = new ExtendedDataTableWODND.DataTable.header(this.id +":header",this);
