 ...
 *
 */
public class ExtendedTableHolderWODND extends TableHolder {
	 ...
	 * @param table
	 */
	public ExtendedTableHolderWODND(UIExtendedDataTableWODND table) {
		super(table);
		lastData = null;
		lastKey = null;
		groupRowCounter = 0;
    ...
    public UIExtendedDataTableWODND getTable() {
		return (UIExtendedDataTableWODND)super.getTable();
	}
