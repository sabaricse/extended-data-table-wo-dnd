 ...
 * 
 */
public abstract class TableMenuRendererWODND implements Serializable {

    public final static String CHANGE_COL_VISIBILITY = "change_col_v";

    protected FacesContext context;
    protected UIExtendedDataTableWODND table;
     ...
     * @throws IOException
     */
    public String renderMenu(FacesContext context, UIExtendedDataTableWODND table,
