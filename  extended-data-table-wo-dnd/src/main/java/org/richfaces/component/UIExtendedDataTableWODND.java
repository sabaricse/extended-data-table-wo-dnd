 ...
 * 
 */
public abstract class UIExtendedDataTableWODND extends UIDataTable implements
		Selectable, Filterable, Sortable2 {

	/**
	 * COMPONENT_TYPE
	 */
	public static final String COMPONENT_TYPE = "org.richfaces.ExtendedDataTableWODND";

	/**
	 * COMPONENT_FAMILY
	 */
	public static final String COMPONENT_FAMILY = "org.richfaces.ExtendedDataTableWODND";
	
	protected ExtendedDataTableStateWODND state;
	...
	public void queueEvent(FacesEvent event) {
	    if(event.getSource() instanceof UIExtendedDataTableWODND) {
    		if (event instanceof AjaxEvent) {
	...
	public Iterator<UIColumn> getSortedColumns() {
		return new SortedColumnsIteratorWODND(this);
	}

	public Iterator<UIColumn> getChildColumns() {
		return new ExtendedTableColumnsIteratorWODND(this);
	}
	...
	public boolean isGroupingOn() {
		...
		return ((groupingColumnId!=null) && (!"".equals(groupingColumnId)) && (!ExtendedDataTableStateWODND.NONE_COLUMN_ID.equals(groupingColumnId)));
	}
...
//		this.state = (ExtendedDataTableStateWODND) values[1];
//	}
	...
	protected ExtendedDataTableStateWODND getState() {
		if (state == null){
			state = ExtendedDataTableStateWODND.getExtendedDataTableState(this);
		}
		return state;
	}
