...
public class AbstractExtendedTableRendererTest extends AbstractAjax4JsfTestCase {
    ...
    private ExtendedTableRendererWOND renderer;
    private UIExtendedDataTableWODND table;

    public AbstractExtendedTableRendererTest(String name) {
        super(name);
        renderer = new ExtendedTableRendererWOND();
    }

    public void setUp() throws Exception {
        super.setUp();
        application.addComponent(UIExtendedDataTableWODND.COMPONENT_TYPE,
                "org.richfaces.component.DefaultExtendedDataTable");
        table = (UIExtendedDataTableWODND) application
                .createComponent(UIExtendedDataTableWODND.COMPONENT_TYPE);
    ...
    public void testEncodeOneRow() {
        try {
            setupResponseWriter();
            ExtendedTableHolderWODND holder = new ExtendedTableHolderWODND(table);
...
//        column.setId("columnId");
    ...
    public void testGetJavaScriptVarName() {
        assertEquals("window.ExtendedDataTableWODND.DataTable_extDT", renderer
