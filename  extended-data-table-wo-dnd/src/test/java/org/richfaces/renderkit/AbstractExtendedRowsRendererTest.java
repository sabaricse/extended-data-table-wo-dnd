...
public class AbstractExtendedRowsRendererTest extends AbstractAjax4JsfTestCase {
    ...
    public void testProcess() {
        Object rowKey = 100;
        ExtendedTableHolderWODND eth = new ExtendedTableHolderWODND(table);
        int count = eth.getRowCounter();
        Object argument = (Object) eth;
        try {
            rr.process(facesContext, rowKey, argument);
            eth = (ExtendedTableHolderWODND) argument;
        ...
        eth = (ExtendedTableHolderWODND) argument;
        assertEquals(count + 1, ((ExtendedTableHolderWODND) argument)
                .getRowCounter());
