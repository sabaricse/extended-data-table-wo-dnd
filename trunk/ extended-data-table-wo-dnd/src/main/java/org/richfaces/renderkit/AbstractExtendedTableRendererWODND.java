...
import org.richfaces.component.UIExtendedDataTableWODND;
...
import org.richfaces.renderkit.html.RichTableMenuRendererWODND;
import org.richfaces.renderkit.html.TableMenuRendererWODND;
 ...
 * 
 */
public abstract class AbstractExtendedTableRendererWODND extends
        AbstractExtendedRowsRendererWODND {
    ...
    //private final Log log = LogFactory.getLog(UIExtendedDataTableWODND.class);
    ...
    public void encodeColumns(FacesContext context,
            UIExtendedDataTableWODND table) throws IOException {
    ...
    public void encodeHeader(FacesContext context, UIExtendedDataTableWODND table)
            throws IOException {
    ...
    private void encodeFilterRow(FacesContext context, ResponseWriter writer,
            UIExtendedDataTableWODND table, Iterator<UIColumn> headers,
     ...
     * @author pbuda
     */
    private boolean filteringEnabled(UIExtendedDataTableWODND table) {
    ...
    public void encodeFooter(FacesContext context, UIExtendedDataTableWODND table)
            throws IOException {
    ...
    private void encodeFakeIeRow(FacesContext context,
            UIExtendedDataTableWODND table, ExtendedTableHolderWODND holder)
            throws IOException {
    ...
    protected boolean rowGroupChanged(FacesContext context,
            ExtendedTableHolderWODND holder) {
        UIExtendedDataTableWODND table = holder.getTable();
    ...
    public void encodeOneRow(FacesContext context, ExtendedTableHolderWODND holder)
            throws IOException {
        UIExtendedDataTableWODND table = holder.getTable();
        ResponseWriter writer = context.getResponseWriter();
...
//            } else 
    ...
    public String createClientDataTable(FacesContext context,
            UIExtendedDataTableWODND table) {
        JSFunction function = new JSFunction("new ExtendedDataTableWODND.DataTable");
    ...
    protected JSFunctionDefinition getShowMenuFunction(FacesContext context,
            UIDataTable table) {
        return new RichTableMenuRendererWODND().createShowMenuEventFunction();
    }
...
//        }
    ...
    protected void doDecode(FacesContext context, UIComponent component) {
        ...
        if (component instanceof UIExtendedDataTableWODND) {
            UIExtendedDataTableWODND table = (UIExtendedDataTableWODND) component;
...
//                        + TableDragDropRendererWODND.DRAG_SOURCE_SCRIPT_ID);
//                Pattern targetPattern = Pattern.compile(clientId + ":(\\w*):"
//                        + TableDragDropRendererWODND.DROP_TARGET_SCRIPT_ID + "("
//                        + TableDragDropRendererWODND.DROP_TARGET_BEFORE + "|"
//                        + TableDragDropRendererWODND.DROP_TARGET_AFTER + ")");
...
//                            .equals(TableDragDropRendererWODND.DROP_TARGET_BEFORE));
//
//                    dragDropEvent.queue();
//
//                    // AjaxContext.getCurrentInstance().addComponentToAjaxRender(component);
...
//            }// change column order
            ...
            String columnToChange = (String) map.get(clientId + ":"
                    + TableMenuRendererWODND.CHANGE_COL_VISIBILITY);
...
//        TableDragDropRendererWODND.getInstance(context).encodeChildScripts(context,
//                component);
//        return "";
//    }
...
//            throws IOException {
//        TableDragDropRendererWODND.getInstance(context).renderDragSupport(column,
...
//        TableDragDropRendererWODND renderer = TableDragDropRendererWODND
//                .getInstance(context);
...
//    }// renderDropSupport
    ...
    public static String getJavaScriptVarName(FacesContext context,
        ...
        String name = "ExtendedDataTableWODND.DataTable_"
    ...
    public void encodeTableMenu(FacesContext context, UIExtendedDataTableWODND table)
            throws IOException {
        AjaxContext ajaxContext = AjaxContext.getCurrentInstance();
        Object key = table.getRowKey();
        table.setRowKey(null);
        TableMenuRendererWODND menuRenderer = new RichTableMenuRendererWODND();
