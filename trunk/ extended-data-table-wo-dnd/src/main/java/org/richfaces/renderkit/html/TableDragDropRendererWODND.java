 ...
 * {@link org.richfaces.component.UIExtendedDataTableWODND} component specialized for
 * changing table columns order event.
 * 
 * @author pawelgo
 * 
 */
public class TableDragDropRendererWODND implements Serializable {
	...
	private TableDragDropRendererWODND(FacesContext context) {
        super();
     ...
     */
    public static TableDragDropRendererWODND getInstance(FacesContext context) {
        return new TableDragDropRendererWODND(context);
    }
    ...
    public void renderDragSupport(UIColumn column, String dragSourceId,
        ...
        ExtDraggableRendererContributorWODND contributor = ExtDraggableRendererContributorWODND
                .getInstance();
    ...
    public void renderDropSupport(UIColumn column, String dropTargetId,
        ...
        ExtDropzoneRendererContributorWODND contributor = ExtDropzoneRendererContributorWODND
                .getInstance();
