...
import org.richfaces.renderkit.html.TableSelectionRendererContributorWODND;

/**
 * @author shura
 * 
 */
public abstract class AbstractExtendedRowsRendererWODND extends
    ...
    protected class CompositeRendererEnabler extends CompositeRenderer {
        public CompositeRendererEnabler() {
            addContributor(new TableSelectionRendererContributorWODND());
//            addContributor(ExtDraggableRendererContributorWODND.getInstance());
//            addContributor(ExtDropzoneRendererContributorWODND.getInstance());
        }

        protected Class<? extends UIComponent> getComponentClass() {
            return AbstractExtendedRowsRendererWODND.this.getComponentClass();
        }
    ...
    // protected TableMenuRendererWODND menuRenderer = new RichTableMenuRendererWODND();
    ...
    public void process(FacesContext context, Object rowKey, Object argument)
            throws IOException {
        ExtendedTableHolderWODND holder = (ExtendedTableHolderWODND) argument;
    ...
    public void encodeRows(FacesContext context, UIComponent component)
            throws IOException {
        encodeRows(context, component, new ExtendedTableHolderWODND(
                (UIExtendedDataTableWODND) component));
    }
    ...
    protected void encodeRows(FacesContext context, UIComponent component,
            ExtendedTableHolderWODND tableHolder) throws IOException {
    ...
    public abstract void encodeOneRow(FacesContext context,
            ExtendedTableHolderWODND holder) throws IOException;
