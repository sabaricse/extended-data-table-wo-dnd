 ...
 * {@link org.richfaces.component.UIExtendedDataTableWODND} component. All
 * functionality from wrapped
 * {@link org.richfaces.renderkit.DraggableRendererContributor} are available
 * and special method
 * {@link ExtDraggableRendererContributorWODND#buildOptions(FacesContext, UIComponent, String, String)}
 * is added.
 * 
 * @author pawelgo
 * 
 */
public class ExtDraggableRendererContributorWODND implements RendererContributor {

    private static ExtDraggableRendererContributorWODND instance;

    private static RendererContributor wrappedContributor;

    private ExtDraggableRendererContributorWODND() {
        super();
    }

    public static synchronized ExtDraggableRendererContributorWODND getInstance() {
        if (instance == null) {
            instance = new ExtDraggableRendererContributorWODND();
