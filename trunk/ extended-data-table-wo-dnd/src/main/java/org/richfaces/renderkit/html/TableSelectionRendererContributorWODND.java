 ...
 * for {@link org.richfaces.component.UIExtendedDataTableWODND} component.
 * 
 * @author pawelgo
 * 
 */
public class TableSelectionRendererContributorWODND implements RendererContributor,
    ...
    public void decode(FacesContext context, UIComponent component,
        ...
        final UIExtendedDataTableWODND table = (UIExtendedDataTableWODND) component;
    ...
    public Class<?> getAcceptableClass() {
        return UIExtendedDataTableWODND.class;
    }
    ...
    public ScriptOptions buildOptions(FacesContext context,
        ...
        scriptOptions.addOption("selectionInput", getSelectionInputName(
                context, (UIExtendedDataTableWODND) component));
    ...
    public void encode(FacesContext context, UIComponent component)
            throws IOException {
        UIExtendedDataTableWODND grid = (UIExtendedDataTableWODND) component;
    ...
    private void encodeSelection(FacesContext context,
            final UIExtendedDataTableWODND table) throws IOException {
     ...
     * @throws IOException
     */
    public void writeSelection(FacesContext context, UIExtendedDataTableWODND table)
            throws IOException {
