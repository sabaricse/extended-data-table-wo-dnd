 ...
 * Used only with {@link org.richfaces.component.UIExtendedDataTableWODND} component.
 * All functionality from wrapped {@link org.richfaces.renderkit.DropzoneRendererContributor} are available.
 * Also special methods {@link ExtDropzoneRendererContributorWODND#buildOptions(FacesContext, UIComponent)}
 * and {@link ExtDropzoneRendererContributorWODND#getScriptContribution(FacesContext, UIComponent, String, JSFunctionDefinition)}
 * are added.
 * 
 * @author pawelgo
 *
 */
public class ExtDropzoneRendererContributorWODND implements RendererContributor {
	
	private ExtDropzoneRendererContributorWODND() {
		super();
	}

	private static ExtDropzoneRendererContributorWODND instance;
	
	private static RendererContributor wrappedContributor;

	public static synchronized ExtDropzoneRendererContributorWODND getInstance() {
		if (instance == null) {
			instance = new ExtDropzoneRendererContributorWODND();
	...
	public String getScriptContribution(FacesContext context, UIComponent column, String dropTargetScriptId, JSFunction preSendAjaxRequestFunction, JSFunctionDefinition onAjaxCompleteFunction) {
		...
		String dragSourceScriptId = column.getClientId(context) + ":"+ TableDragDropRendererWODND.DRAG_SOURCE_SCRIPT_ID;
