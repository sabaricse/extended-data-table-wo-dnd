 ...
 * 
 * @see UIExtendedDataTableWODND#getSortedChildren()
 * @author pawelgo
 * 
 */
public class SortedColumnsIteratorWODND extends ExtendedTableColumnsIteratorWODND {
     ...
     */
    public SortedColumnsIteratorWODND(UIExtendedDataTableWODND dataTable) {
        super(dataTable);
