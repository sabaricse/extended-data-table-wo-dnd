 ...
 *
 */
public class ExtendedDataTableStateWODND implements Serializable {

	private static final long serialVersionUID = -3103664821855261335L;

	public static final String NONE_COLUMN_ID = "none";
	
	protected ColumnsOrderWODND columnsOrder;
	protected ColumnsVisibilityWODND columnsVisibility;
	protected ColumnsSizeStateWODND columnsSizeState;
	protected ColumnGroupingStateWODND columnGroupingState;
	
	public static ExtendedDataTableStateWODND getExtendedDataTableState(UIExtendedDataTableWODND extendedDataTable){
		ExtendedDataTableStateWODND state = new ExtendedDataTableStateWODND();
	 ...
	 */
	protected void init(UIExtendedDataTableWODND extendedDataTable){
		...
		try{
			columnsOrder = ColumnsOrderWODND.getColumnsOrder(extendedDataTable, (stateMap == null ? null : (JSONCollection) stateMap.get("columnsOrder")));
		}
		catch(Exception e){
			columnsOrder = ColumnsOrderWODND.getColumnsOrder(extendedDataTable, (JSONCollection) null);
		}
		//initialize columns visibility part
		try{
			columnsVisibility = ColumnsVisibilityWODND.getColumnsVisibility(extendedDataTable, (stateMap == null ? null : (JSONMap) stateMap.get("columnsVisibility")));
		}
		catch(Exception e){
			columnsVisibility = ColumnsVisibilityWODND.getColumnsVisibility(extendedDataTable, (JSONMap) null);
		}
		//initialize columns size part
		try{
			columnsSizeState = ColumnsSizeStateWODND.getColumnsSize(extendedDataTable, (stateMap == null ? null : (JSONMap) stateMap.get("columnsSizeState")));
		}
		catch(Exception e){
			columnsSizeState = ColumnsSizeStateWODND.getColumnsSize(extendedDataTable, (JSONMap) null);
		}
		//initialize column grouping part
		try{
			columnGroupingState = ColumnGroupingStateWODND.getColumnGropingState(extendedDataTable, (stateMap == null ? null : (JSONMap) stateMap.get("columnGroupingState")));
		}
		catch(Exception e){
			columnGroupingState = ColumnGroupingStateWODND.getColumnGropingState(extendedDataTable, (JSONMap) null);
		}
	}//init	
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsOrderWODND#changeOrder(String, String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsOrderWODND#sortColumns(FacesContext, List)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsVisibilityWODND#isVisible(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsVisibilityWODND#toggleVisibility(UIExtendedDataTableWODND, String)
	 */
	public void toggleColumnVisibility(UIExtendedDataTableWODND extendedDataTable,
			String columnId) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsSizeStateWODND#changeColumnSize(UIExtendedDataTableWODND, String)
	 */
	public void changeColumnSize(UIExtendedDataTableWODND extendedDataTable,
			String newValue) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnsSizeStateWODND#getColumnSize(UIComponent)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#getGroupingColumnId()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#groupBy(String, Ordering)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#resetGroupVisibilityState()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#disableGrouping()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#groupIsExpanded(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ColumnGroupingStateWODND#toggleGroup(int)
	 */
...
class ColumnsSizeStateWODND implements Serializable{
	...
	private ColumnsSizeStateWODND() {
		super();
	}
	
	static ColumnsSizeStateWODND getColumnsSize(UIExtendedDataTableWODND extendedDataTable, JSONMap state){
		ColumnsSizeStateWODND columnsSize = new ColumnsSizeStateWODND();
	 ...
	 */
	private void init(UIExtendedDataTableWODND extendedDataTable, JSONMap state){
		value = null;
	 ...
	 */
	private void createDefaultColumnsSizeState(UIExtendedDataTableWODND extendedDataTable){
		try {
...
//	}
	...
	public void changeColumnSize(UIExtendedDataTableWODND extendedDataTable, String newValue){
		if (value == null)
			return;
		try {
...
}//ColumnsSizeStateWODND

class ColumnsOrderWODND implements Serializable{

	private static final long serialVersionUID = 907700564445889954L;

	private JSONArray value;

	private ColumnsOrderWODND() {
		super();
	}
	
	static ColumnsOrderWODND getColumnsOrder(UIExtendedDataTableWODND extendedDataTable, JSONCollection collection){
		ColumnsOrderWODND columnsOrder = new ColumnsOrderWODND();
		columnsOrder.init(extendedDataTable, collection);
		return columnsOrder;
	}
	
	static ColumnsOrderWODND getColumnsOrder(UIExtendedDataTableWODND extendedDataTable, String val) throws JSONException{
		ColumnsOrderWODND columnsOrder = new ColumnsOrderWODND();
	 ...
	 * Converts its state from String representation or create default state if it is not set.
	 */
	private void init(UIExtendedDataTableWODND extendedDataTable, JSONCollection collection){
		value = null;
	 ...
	 * Create default column order based on component children.
	 */
	private void createDefaultColumnsOrder(UIExtendedDataTableWODND extendedDataTable){
		value = new JSONArray();
		for (Iterator<UIColumn> iter = extendedDataTable.getChildColumns(); iter.hasNext();) {
			UIColumn col = iter.next();
			value.put(col.getId());
...
class ColumnsVisibilityWODND implements Serializable{
	...
	private ColumnsVisibilityWODND() {
		super();
	}
	
	static ColumnsVisibilityWODND getColumnsVisibility(UIExtendedDataTableWODND extendedDataTable, String val) throws JSONException{
		ColumnsVisibilityWODND columnsVisibility = new ColumnsVisibilityWODND();
		columnsVisibility.init(extendedDataTable, new JSONMap(val));
		return columnsVisibility;
	}
	
	static ColumnsVisibilityWODND getColumnsVisibility(UIExtendedDataTableWODND extendedDataTable, JSONMap state){
		ColumnsVisibilityWODND columnsVisibility = new ColumnsVisibilityWODND();
	 ...
	 */
	private void createDefaultColumnsVisibility(UIExtendedDataTableWODND extendedDataTable){
		try {
			JSONWriter writer = new JSONStringer().object();
			for (Iterator<UIColumn> iter = extendedDataTable.getChildColumns(); iter.hasNext();) {
				UIColumn col = iter.next();
	 ...
	 */
	void toggleVisibility(UIExtendedDataTableWODND extendedDataTable, String columnId){
		if (value == null)
			return;
...
}//ColumnsVisibilityWODND

class ColumnGroupingStateWODND implements Serializable{
	...
	private ColumnGroupingStateWODND() {
		super();
	}
	
	static ColumnGroupingStateWODND getColumnGropingState(UIExtendedDataTableWODND extendedDataTable, JSONMap map){
		ColumnGroupingStateWODND groupingState = new ColumnGroupingStateWODND();
	 ...
	 * Converts its state from String representation or create default state if it is not set.
	 */
	private void init(UIExtendedDataTableWODND extendedDataTable, JSONMap map){
		columnId = null;
...
//			}
	...
	void disableGrouping(){
		columnId = ExtendedDataTableStateWODND.NONE_COLUMN_ID;
		ordering = Ordering.UNSORTED;
		resetGroupVisibilityState();
	}
