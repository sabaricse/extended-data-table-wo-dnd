 ...
 *
 */
public class ExtendedTableColumnsIteratorWODND implements Iterator<UIColumn> {
	 ...
	 */
	public ExtendedTableColumnsIteratorWODND(UIExtendedDataTableWODND dataTable) {
		super();
