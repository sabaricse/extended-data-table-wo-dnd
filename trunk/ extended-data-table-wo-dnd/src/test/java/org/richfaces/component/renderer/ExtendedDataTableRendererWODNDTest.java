 ...
 *
 */
public class ExtendedDataTableRendererWODNDTest extends AbstractAjax4JsfTestCase {
    
    private UIExtendedDataTableWODND table;
    
    private Set<String> javascripts = new HashSet<String>();
    
    
    public ExtendedDataTableRendererWODNDTest(String name) {
        super(name);
    }
    ...
    public void setUp() throws Exception {
        ...
        //Create data table
        table = (UIExtendedDataTableWODND) application.createComponent(UIExtendedDataTableWODND.COMPONENT_TYPE);
        table.setId("table");
        ...
        javascripts.add("org/richfaces/renderkit/html/scripts/extended-data-table-WODND.js");
    }
    ...
    public void testLoadingStyles() throws Exception {
        ...
        assertNotNull(links);
        //find extendedDataTableWODND.xcss
        HtmlElement link = null;
        for (Object l : links){
        	if (((HtmlElement)l).getAttributeValue("href").contains("css/extendedDataTableWODND.xcss")){
        		link = (HtmlElement)l;
        		break;
        	}
        }
